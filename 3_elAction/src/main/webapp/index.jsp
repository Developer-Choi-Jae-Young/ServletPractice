...
<body>
	...
	<p>
		기존에 사용했던 표현식(출력식) : $lt;%= 변수/메소드호출 %gt; <br>
	...
	<%--
	 ...
	 <p>
	 	...
	 	공통적으로 사용되는 코드를 합하여 보다 쉽게 사용할 수 있도록 태그화하여 표준으로 제공되는 라이브러리
	 </p>
	 
	 <h4>라이브러리 추가</h4>
	 <ol>
	 	<li><a href="https://tomcat.apache.org/">톰캣사이트</a> 접속</li>
	 	<li>메뉴에서 tablib 메뉴를 찾아 접속(Download - taglibs)</li>
	 ...
	 <p>
	 	...
	 	&lt;%@ tablib prefix="접두어" uri="라이브러리 파일상의 uri주소" %&gt;
	 </p>
